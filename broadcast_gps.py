...
print("GPS Status: %s" % vehicle.gps_0)
print("GPS lock. 2=2D-fix, 3=3D-fix 4=GNSS+dead reckoning")
print("GPS reporting in WGS84 coordinate system")

while(True):
    location = vehicle.location.global_frame
    print("lat=%s lon=%s alt=%s" % (location.lat, location.lon, location.alt))
    time.sleep(2)
